...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LambdaLibrary.FILTER_BY_SALARY_AND_LASTNAME.apply(list, 100000, "[F-Z]+.*"));
        ...
        System.out.println(LambdaLibrary.FILTER_BY_SALARY_AND_FIRSTNAME.apply(list, 85000, "[A-Q]+.*"));
    }
